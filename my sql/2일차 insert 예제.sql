...
-- insert into student values('2021160124','hong123','pw123','황길동','020505-3123456');
...
-- 교후번호가 2000160001인 이순신 교수님의 정보를 추가하는 쿼리문을 작성하세요.
-- id : lee, pw : leelee, 주민번호 : 550505-1234567
-- insert into professor(pr_num, pr_pw, pr_id, pr_name, pr_reg_num)
-- 	value('2000160001', 'leelee', 'lee', '이순신', '550505-1234567');
--     SELECT * FROM professor;

-- 과목명이 컴퓨터 개론이고, 과목 코드는 MSC001, 일정과 분반은 미정인 과목을 추가하는 쿼리문을 작성하세요.
-- insert into subject(su_code,su_title) value('MSC001','컴퓨터 개론');
-- select * from subject;
